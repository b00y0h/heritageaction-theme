				...
				<?php
				  global $post;
					if ( is_category() ) {
						...
						printf( __( 'Keyword Archives: %s', 'heritageaction' ), '<span>' . single_tag_title( '', false ) . '</span>' );
						...
						*/
						the_post();
						printf( __( 'Author Archives: %s', 'heritageaction' ), '<span class="vcard"><a class="url fn n" href="' . get_author_posts_url( get_the_author_meta( "ID" ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
